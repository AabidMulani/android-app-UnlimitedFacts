...
//        mainTextColor=Color.parseColor("##FFD810");
        if (Build.VERSION.SDK_INT >= 16) {
            ...
            holderLayout.setBackgroundDrawable(new ColorDrawable(type == 0 ? Color.BLACK : Color.WHITE));
        }
        if (refreshLayout) {
            if (selectedTab != 1) {
                showQuotesTab();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_share) {
            ...
            shareIntent.putExtra(android.content.Intent.EXTRA_TEXT, "https://play.google.com/store/apps/details?id=com.probytemedia.unlimitedfacts");
